...
edges_csv_file_name = "../output/edges_" + (jdk_version.replace(".", "_")) + ".csv"
...
classes_csv_file_name = "../output/classes_" + (jdk_version.replace(".", "_")) + ".csv"
...
info_csv_file_name = "../output/info_" + (jdk_version.replace(".", "_")) + ".csv"
